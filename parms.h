...
#define PARM_FLAG_INPLACE   32 /* modify a supported source VDI directly */
#define PARM_FLAG_FORCE_ENCRYPTED 64 /* allow in-place modification after encryption warning */
#define PARM_FLAG_RESUME    128 /* resume an interrupted in-place operation */
#define PARM_FLAG_BATCHMODE 256 /* non-interactive background batch task */
