...
UI32 Env_AskRiskYN(PSTR szMsg, PSTR szCaption);
...
// is stored in. idLanguage is a code indicating the preferred language.
// 0=en, 1=zh-CN, 2=de, 3=ja, 4=fr, 5=es, 6=zh-TW, 7=ko, 8=ru, 9=pt-BR.
