...
#define IDS_ENC_CLONE_WARN (IDS_CLONEVDI+8)
#define IDS_ENC_INPLACE_WARN (IDS_CLONEVDI+9)
#define IDS_INPLACE_CONFIRM (IDS_CLONEVDI+10)
#define IDS_RECOVER_CONFIRM (IDS_CLONEVDI+11)
#define IDS_RISK_TITLE     (IDS_CLONEVDI+12)
#define IDS_INPLACE_FAILED (IDS_CLONEVDI+13)
#define IDS_RECOVERY_FOUND (IDS_CLONEVDI+14)
#define IDS_ENC_CLI_WARN   (IDS_CLONEVDI+15)

/* strings from encryption.c */
#define IDS_ENCRYPTION     (IDS_CLONEVDI+30)
#define IDS_ENC_NOTSCANNED (IDS_ENCRYPTION+0)
#define IDS_ENC_NONE       (IDS_ENCRYPTION+1)
#define IDS_ENC_INCOMPLETE (IDS_ENCRYPTION+2)
#define IDS_ENC_PARTITION  (IDS_ENCRYPTION+3)
#define IDS_ENC_SUSPECTED  (IDS_ENCRYPTION+4)
#define IDS_ENC_UNKNOWN    (IDS_ENCRYPTION+5)
...
#define IDS_USAGE20         (IDS_CMDLINE+20)
#define IDS_USAGE21         (IDS_CMDLINE+21)
#define IDS_USAGE_LAST      IDS_USAGE21
#define IDS_BANNER0         (IDS_CMDLINE+22)  /* = "\015\012CloneVDI %lu.%02lx\015\012" */
#define IDS_BANNER1         (IDS_CMDLINE+23)  /* = "Copyright (C) %lu, Don Milne\015\012" */
#define IDS_BANNER2         (IDS_CMDLINE+24)  /* = "Feedback to: mpack on forums.virtualbox.org\r\n" */
#define IDS_ARGERR          (IDS_CMDLINE+25)  /* = "Error in argument %lu: %s.\015\012" */
#define IDS_OPTTWICE        (IDS_CMDLINE+26)  /* = "Error in argument %lu: %s option specified twice.\015\012" */
#define IDS_NOFILEN         (IDS_CMDLINE+27)  /* = "output option specified, no filename provided" */
#define IDS_NODSIZE         (IDS_CMDLINE+28)  /* = "enlarge option specified, no disk size provided" */
#define IDS_UNKOPT          (IDS_CMDLINE+29)  /* = "unknown option." */
#define IDS_INVOPT          (IDS_CMDLINE+30)  /* = "Invalid option format (embedded space?)" */
#define IDS_SRCTWICE        (IDS_CMDLINE+31)  /* = "Source name given twice? Dest file should be specified using --output <fn> option" */
#define IDS_NEEDSRC         (IDS_CMDLINE+32)  /* = "Source filename is missing" */
#define IDS_VOPTOUTPUT      (IDS_CMDLINE+33)  /* = "output" */
#define IDS_VOPTKEEPUUID    (IDS_CMDLINE+34)  /* = "keepuuid" */
#define IDS_VOPTENLARGE     (IDS_CMDLINE+35)  /* = "enlarge" */
#define IDS_VOPTCOMPACT     (IDS_CMDLINE+36)  /* = "compact" */
#define IDS_VOPTHELP        (IDS_CMDLINE+37)  /* = "help" */
#define IDS_CHAROPT         (IDS_CMDLINE+38)  /* = "okech"  */
#define IDS_INPLACECONFLICT (IDS_CMDLINE+39)
#define IDS_INPLACENEEDSOP  (IDS_CMDLINE+40)
#define IDS_FORCECONFLICT   (IDS_CMDLINE+41)
#define IDS_RESUMECONFLICT  (IDS_CMDLINE+42)
...
/* cow.c */
#define IDS_COW             (IDS_VDIW+40)
#define IDS_COW_INVHANDLE   (IDS_COW+0)
#define IDS_COW_OUTOFMEM    (IDS_COW+1)
#define IDS_COW_INVBLOCK    (IDS_COW+2)
#define IDS_COW_SEEK        (IDS_COW+3)
#define IDS_COW_READ        (IDS_COW+4)
#define IDS_COW_INVALIDMOVE (IDS_COW+5)
