...
#define IDS_INPLACECONFLICT (IDS_CMDLINE+37)
#define IDS_INPLACENEEDSOP  (IDS_CMDLINE+38)
#define IDS_FORCECONFLICT   (IDS_CMDLINE+39)
#define IDS_RESUMECONFLICT  (IDS_CMDLINE+40)
