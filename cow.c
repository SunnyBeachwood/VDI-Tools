...
static __declspec(thread) UINT OSLastError;

static PSTR pszOK;
static PSTR pszUNKERROR;
static PSTR pszCOW_INVHANDLE;
static PSTR pszCOW_OUTOFMEM;
static PSTR pszCOW_INVBLOCK;
static PSTR pszCOW_SEEK;
static PSTR pszCOW_READ;
static PSTR pszCOW_INVALIDMOVE;
...
COW_GetErrorString(UINT nErr)
{
   ...
   switch (nErr) {
      ...
      case COW_ERR_INVHANDLE:
         pszErr=RSTR(COW_INVHANDLE);
         break;
      case COW_ERR_OUTOFMEM:
         pszErr=RSTR(COW_OUTOFMEM);
         break;
      case COW_ERR_INVBLOCK:
         pszErr=RSTR(COW_INVBLOCK);
         break;
      case COW_ERR_SEEK:
         Env_sprintf(sz,RSTR(COW_SEEK),OSLastError);
         pszErr=sz;
         break;
      case COW_ERR_READ:
         Env_sprintf(sz,RSTR(COW_READ),OSLastError);
         pszErr=sz;
         break;
      case COW_ERR_INVALIDMOVE:
         pszErr=RSTR(COW_INVALIDMOVE);
         break;
      default:
