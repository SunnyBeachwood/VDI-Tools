...
void VDIW_SetNonInteractive(BOOL enabled);
...
BOOL VDIW_Commit(HVDIW hVDI);
/* Flushes all data, writes the final header/block map, and flushes metadata.
 * Call this before Close; failures leave the handle available for Discard. */
